...
const memeGen = 'https://geek-jokes.sameerkumar.website/api'
...
class App extends React.Component  {
  ...
  getMeme() {
    ...
    return request.get(memeGen)
      .then(res => {
        console.log(res)
      })

    // return request.get(memeGen).set('X-Mashape-Key', 'Ltov54pZPAmshLuD5uyb4HjSAeqfp1EGrXXjsnsNpXYKg5N5Wt')
    //   .then(res => {
    //     console.log(res)
    //   })
    //   .catch(err => {
  ...
  render () {
    return (
      ...
      <div>
        ...
        <button onClick={this.getMeme}>Generate Meme</button>
        <h3>Te Reo:</h3>
